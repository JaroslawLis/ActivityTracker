...
<div class="py-4 bg-gray-400 mt-14 md:mt-0"><a href="{{ route('current_bar_charts') }}" class="px-4 py-4 font-bold text-white bg-blue-500 border border-blue-700 rounded hover:bg-blue-700">Bar Charts</a><a href="{{ route('current_charts') }}" class="px-4 py-4 font-bold text-white bg-blue-500 border border-blue-700 rounded hover:bg-blue-700">Line Charts</a></div>
