...
<div class="flex-1 pb-24 mt-12 bg-gray-100 main-content md:mt-2 md:pb-5">
    <div class="pt-3 bg-gray-800">
       ...
       <div class="py-4 bg-gradient-to-r from-blue-900 to-gray-800 mt-14 md:mt-0"><a href="monthly_stat/{{$previous_y}}/{{$previous_m}}" class="px-4 py-4 font-bold text-white bg-blue-500 border border-blue-700 rounded hover:bg-blue-700">Previous month</a></div>
    </div>
    <div class="p-10 ">
        <table class="block min-w-full border-collapse rounded-lg shadow-xl md:table">
            <thead class="block md:table-header-group">
                <tr class="absolute block border border-grey-500 md:border-none md:table-row -top-full md:top-auto -left-full md:left-auto md:relative ">
                    ...
                    <th class="block p-2 font-bold text-left text-white bg-gray-600 md:border md:border-grey-500 md:table-cell">Total</th>
                    <th class="block p-2 font-bold text-left text-white bg-gray-600 md:border md:border-grey-500 md:table-cell">Average</th>
                    <th class="block p-2 font-bold text-left text-white bg-gray-600 md:border md:border-grey-500 md:table-cell">Current Target</th>
                    <th class="block p-2 font-bold text-left text-white bg-gray-600 md:border md:border-grey-500 md:table-cell">Surplus/Shortage</th>
